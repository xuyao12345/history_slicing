...
public class BlockDeletion {
	public static Set<Block> BlockDeletion(Set<Block> block, double alfa,int beta, int oldlength, int newlength){
		...
		while(iterator.hasNext()){
			...
			if(oldperC < alfa && newperC < alfa&&tempB.oldC.size()<beta&&tempB.newC.size()<beta){
				result.add(tempB);
			}
		}
